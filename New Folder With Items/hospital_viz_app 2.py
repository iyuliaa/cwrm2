...
**Colour** = disease chapter. Hover over any block to see exact totals.
""")
...
Colour identifies the disease chapter. Tool: Python / Plotly.
</p>
""", unsafe_allow_html=True)
...
<b>Mental Health</b> is a tiny block, suggesting most mental health care happens outside hospitals.
...
fig_hm.add_annotation(
    ...
    showarrow=False,
    font=dict(size=10, color='#ea580c', family='IBM Plex Sans'),
...
fig_hm.update_layout(
    ...
    plot_bgcolor='white',
    font=dict(family='IBM Plex Sans'),
    xaxis=dict(tickfont=dict(size=9.5), tickangle=-30, showgrid=False),
...
• Colour (hue) → ICD disease chapter (15 distinct colours, Paletton-inspired palette)<br>
