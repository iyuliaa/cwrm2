...
SHORT_LABELS = {
    ...
    'Other diseases of urinary system': 'Disease Urinary',
}
...
def chapter_legend_html(color_map: dict, chapter_totals: pd.Series) -> str:
    ...
    <span style="font-size:1.19rem; color:#64748b;">
    Each colour represents an ICD chapter. Darker shades indicate higher admissions, while lighter shades indicate lower admissions. Chapters are ordered by total burden, and only larger diagnoses are labelled for readability.
    </span>
