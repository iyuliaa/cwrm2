...
.chapter-legend b { color: #0f172a; font-size: 1.1rem}
.chapter-legend-grid {
    display: flex;
    flex-wrap: wrap;
    gap: 0.25rem 1rem;
...
def chapter_legend_html(color_map: dict, chapter_totals: pd.Series) -> str:
    ...
    <span style="font-size:0.99rem; color:#64748b;">
    Each colour represents an ICD chapter. Darker shades indicate higher admissions, while lighter shades indicate lower admissions. Chapters are ordered by total burden, and only larger diagnoses are labelled for readability (>2M).
    </span>
